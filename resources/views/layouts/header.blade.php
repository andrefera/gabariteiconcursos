<header id="header">
    <div class="alignHeader">
        ...
        <a class="imgIcon" href="/">
            <img src="{{ asset('images/icons/user-icon.png') }}" width="18" height="18" alt="Search Icon" class="searchIcon">
            Entrar / Criar conta
        </a>
        <a class="imgIcon" href="/">
            <img src="{{ asset('images/icons/cart-icon.png') }}" width="20" height="20" alt="Search Icon" class="searchIcon">
            <p>Carrinho</p>
        </a>
    </div>
</header>
