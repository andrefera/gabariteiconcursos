                    ...
                    <div class="newsletter-content">
                        ...
                        <form class="newsletter-form" id="newsletterForm" method="POST">
                            ...
                            <div class="newsletter-input-group">
                                ...
                                <button type="submit" class="newsletter-btn" id="newsletterSubmit">
                                    ...
                                    try {
                                        ...
                                        if (data.success) {
                                            ...
                                            if (typeof window.showToast === 'function') {
                                                window.showToast('Sucesso', data.message, 'success');
                                            }
                                            emailInput.value = '';
                                        } else {
                                            // Mostra toast de erro
                                            if (typeof window.showToast === 'function') {
                                                window.showToast('Atenção', data.message, 'error');
                                            }
                                        }
                                    } catch (error) {
                                        // Mostra toast de erro genérico
                                        if (typeof window.showToast === 'function') {
                                            window.showToast('Erro', 'Erro ao processar sua solicitação. Tente novamente mais tarde.', 'error');
                                        }
                                    } finally {
                                        // Reabilita o botão
...
{{--                            <h3>Ellon Sports</h3>--}}
                    ...
                    <div class="footer-column">
                        ...
                        <ul class="footer-links">
                            <li><a href="/camisas/nacional">⚽ Times Brasileiros</a></li>
                            <li><a href="/camisas/internacional">🌍 Times Internacionais</a></li>
                            <li><a href="/camisas/selecao">🏆 Seleções</a></li>
                            <li><a href="/camisas/novidades">🆕 Lançamentos</a></li>
                            <li><a href="/camisas/promocoes">🔥 Promoções</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="footer-column footer-social">
                        ...
                        <div class="social-links">
                            ...
                            <a href="https://www.instagram.com/ellonsports.store/" target="_blank" class="social-link instagram" title="Instagram">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                    <path
