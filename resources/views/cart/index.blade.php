            ...
            <div class="cart-resume">
                ...
                <div class="cart-resume-container">
                    ...
                    <div class="discount-content">
                        <span>Desconto</span>
                        <span class="discount-value">- R$ {{ number_format($cart->discount, 2, ',', '.') }}</span>
                    </div>
                    @endif
                    @if($cart->shipping > 0)
                    <div class="shipping-content">
                        <span>Frete</span>
                        <span class="shipping-value">R$ {{ number_format($cart->shipping, 2, ',', '.') }}</span>
                    </div>
                    @endif
                    <div class="divisor"></div>
                    <div class="total-content">
                        ...
                        <div class="total-resume">
                            ...
                            <h6 class="installment">10 x R$ {{ number_format($cart->installments[4], 2, ',', '.') }} s/ juros</h6>
                            @endif
                        </div>
                    </div>
